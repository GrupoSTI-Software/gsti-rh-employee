...
import { HttpVacationAdapter } from '@modules/calendar/infrastructure/http-vacation.adapter';
import { VACATION_PORT } from '@modules/calendar/domain/vacation.token';
...
import { HttpCalendarAdapter } from '@modules/calendar/infrastructure/http-calendar.adapter';
import { CALENDAR_PORT } from '@modules/calendar/domain/calendar.token';
import { HttpWorkDisabilityAdapter } from '@modules/calendar/infrastructure/http-work-disability.adapter';
import { WORK_DISABILITY_PORT } from '@modules/calendar/domain/work-disability.token';
import { HttpExceptionAdapter } from '@modules/calendar/infrastructure/http-exception.adapter';
import { EXCEPTION_PORT } from '@modules/calendar/domain/exception.token';
